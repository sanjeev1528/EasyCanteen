...
function AdminUpdate() {
    ...
    const[formData,SetFormData] = useState({
      ...
      const handleSubmit = async (e) => {
        e.preventDefault();
        const response = await axios.put('http://localhost:5007/update',formData);
